...
for t=1:1:20
for a=1:1:90
D(t,1)=mt(a,t)*hmt2(a)./1000+wt(a,t)*hwt2(a)./1000+mc(a,t)*hmc2(a)./1000+wc(a,t)*hwc2(a)./1000;
end
end
subplot(2,1,1)
bar(B,'r');
...
axis([0 40 0 1500000000]);
set(gca, 'XTick', 1:40);
title('预测长期全国分段人口随时间的变化');
xlabel('时间（2010+x年）');
ylabel('人口（人）');
